...
/**
* Builds http client to communicate to access API instances.
*
*/
public class HttpClientFactory {
    ...
    *  calls to the access API.
    *
    * @param apiConfiguration configuration to connect to access API
    * @return an client for http calls to access API
    */
     ...
     * @return n client for http calls to access API
     */
